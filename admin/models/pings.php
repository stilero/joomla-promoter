...
class PromoterModelPings  extends PromoterModel { 

	
	
	protected $_default_filter = 'a.response_message';   
 ...
 */
	...
	*/
	...
	{
		$this->_query->select('a.*, b.title');
		$this->_query->from($this->_default_table.' AS a');
                $this->_query->innerJoin('#__promoter_servers AS b ON b.id = a.servers_id');
		$this->_buildContentWhere();		
		$this->_buildContentOrderBy();

                //print $this->_query->__toString();exit;
