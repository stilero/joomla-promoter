<?php
/**
 * @version $Id: #component#.php 96 2011-08-11 06:59:32Z michel $ 1 2012-08-08Z Stilero Webdesign $
* @package	Promoter
...
$config 	=& JComponentHelper::getParams( 'com_promoter' );

$controller = JRequest::getWord('view', 'pings');
...
$classname    = 'PromoterController'.$controller;
