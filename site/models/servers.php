...
/**
 * PromoterModelServers
 * @author $Author$
 */
 
 
class PromoterModelServers  extends JModelItem { 

	
	
	protected $context = 'com_promoter.servers';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Servers', 'Table');
