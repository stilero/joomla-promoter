...
/**
 * PromoterModelProjects
 * @author $Author$
 */
 
 
class PromoterModelProjects  extends JModelItem { 

	
	
	protected $context = 'com_promoter.projects';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Projects', 'Table');
