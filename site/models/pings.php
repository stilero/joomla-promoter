...
class PromoterModelPings  extends JModelItem { 

	
	
	protected $context = 'com_promoter.pings';   
	/**
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Pings', 'Table');
